...
%todo 1. Variante schöner oder? -andere auskommentieren
...
\begin{table}[H]
	\caption{}\label{tab:werte_polarisation}
	\centering
	\input{./tables/messreihe_pol.tex}
\end{table}
...
\begin{table}[H]
	\caption{}\label{tab:werte_interferometer}
	\centering
	\input{./tables/messreihe_michelson.tex}
\end{table}
...
$\Delta x$ zwischen den zwei Maximal auseinanderliegendene Intesitätmaxima und
...
\begin{table}
	...
	\input{./tables/messreihe_doppeltspaltMaxMax.tex}
\end{table}
...
Nun werden die Interferenzmuster der Intestäts mit den theoretischen Verläufen
...
Malus-Gesetzs auch eingezeichnet. Für die eingehende Beleuchtungstärke ist die
hälfte der Beleuchtungstärke ohne Polarisatoren genommen worden, welche zu
...
%todo max falls dir noch was bei der auswertung einfallt bitte disk ergänzen
\subsection{Young'scher Doppelspalt, Beugungsgitter}
...
\subsection{Michelson Interferometer}
Hier wird die durch das Michelson-Interferomet ermittelte Wellelänge des LASERs
$\lambda$ angeführt.
\begin{enumerate}
	\item $\lambda = \SI{580(30)}{\nm}$
\end{enumerate}
